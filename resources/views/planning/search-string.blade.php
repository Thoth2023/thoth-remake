                                ...
                                <div class="card-group card-frame mt-5"> 
                                    <div class="card">
                                            ...
                                            <div class="card-header pb-0">
                                                ...
                                                <div class="modal-dialog modal-danger modal-dialog-centered modal-" role="document">
                                                    ...
                                                    <div class="modal-header">
                                                        <h6 class="modal-title" id="modal-title-notification-3">Help Search String</h6>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <h4 class="text-black mt-4">The terms help to focus your search appropriately, looking for items that have had a specific term applied by an indexer.
                                                            After determining all relevant terms, you should relate them if all their synonyms to make your search string broader.</h4>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="card-body mt-n3">
                                            {{-- add term --}}
                                            <form role="form" method="POST" action="{{ route('planning_search_string.add_term', $project->id_project) }}" style="display: flex;">
                                                @csrf
                                                <div class="col-md-5">
                                                    <div class="form-group">
                                                        <label for="example-text-input" class="form-control-label">Term</label>
                                                        <input class="form-control" type="text" name="description_term" id="descriptionTermInput" placeholder="Enter the term">
                                                    </div>
                                        ...
                                        <div class="card">
                                            <div class="card-header pt-0 pb-0" >
                                              ...
                                              <button type="button" class="bg-gradient-warning mb-3 help-thoth-button" data-bs-toggle="modal" data-bs-target="#modal-notification-4">?</button>
                                              <div class="modal fade" id="modal-notification-4" tabindex="-1" role="dialog" aria-labelledby="modal-notification-4" aria-hidden="true">
                                                <div class="modal-dialog modal-danger modal-dialog-centered modal-" role="document">
                                                  <div class="modal-content">
                                                    <div class="modal-header">
                                                      <h6 class="modal-title" id="modal-title-notification-4">Help Synonym</h6>
                                                      <button type="button" class="btn btn-danger small-button" data-bs-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">x</span>
                                                      </button>
                                                    </div>
                                                    <div class="modal-body">
                                                      <div class="py-3 text-center">
                                                        <h4 class="text-black mt-4">Fill in this help.</h4>
                                                      </div>
                                                    </div>
                                                    <div class="modal-footer">
                                                      <button type="button" class="btn btn-white" data-bs-dismiss="modal">Ok, Got it</button>
                                                      ...
                                                      <div class="col-md-5">
                                                          ...
                                                          <select class="form-select" id="termSelect" name="term">
                                                            ...
                                                            @foreach ($terms as $term)
                                                                <option value="{{ $term->id_term }}">{{ $term->description }}</option>
                                                            @endforeach
                                                          </select>
                                                        </div>
                                                      </div>
                                                      <div class="col-md-5 text-start">
                                                        <label for="example-text-input" class="form-control-label">Synonym</label>
