...
<div id="chat-container" style="position:fixed; bottom:20px; right:20px; width:320px; z-index:9999; font-family:inherit;">
    <div id="chat-header" class="bg-gradient-faded-dark text-white p-3 rounded-top shadow cursor-pointer d-flex justify-content-between align-items-center">
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <button id="resize-btn" class="btn btn-sm btn-light text-dark" style="padding: 2px 8px; font-size: 12px;">
                ⤢
            </button>
        </div>
    </div>
    ...
    <div id="chat-body" class="bg-white border rounded-bottom shadow chat-small" style="display:none;">
        <div id="chat-box" class="p-3" style="height:180px; overflow-y: auto; font-size:14px;"></div>
