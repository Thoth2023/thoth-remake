...
<head>
    ...
    <style>
        ...
        .col-title { width: 50%; }
        .col-year { width: 10%; }
        .col-database { width: 23%; }
        .col-status { width: 10%; }
        .col-peer-review { width: 10%; }
    </style>
</head>
<body>
<h3 style="text-align: center; font-size: 18px;">Data Extraction | Researcher: {{ $papers->first()->firstname }} {{ $papers->first()->lastname}} </h3>
...
<table class="table table-bordered">
    ...
    @foreach ($papers as $paper)
        <tr>
            ...
            <td class="col-database">{{ $paper->database_name ?? 'N/A' }}</td>
