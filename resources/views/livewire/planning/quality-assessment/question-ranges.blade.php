...
<div class="card">
    <div class="card-header pb-0">
        {{-- Modal de ajuda com título e conteúdo descritivo --}}
        <x-helpers.modal
    ...
    <div class="card-body pb-1">
        {{-- Lista de itens (faixas de pontuação) --}}
        <div class="d-flex flex-column gap-2" id="item-container">
            @foreach ($items as $item)
                <div class="d-flex gap-1">
                    {{-- Campo de valor mínimo da faixa --}}
                    <x-input
                        label="Min"
                        type="number"
                        placeholder="0.01"
                    ...
                    <x-input
                        ...
                        {{-- Quando o campo perde o foco, atualiza o valor no back-end --}}
                    ...
                    <div class="btn-group">
                        <x-input
                            ...
                            placeholder="Good"
                            class="max-input"
                            style="min-width: 75px; border-radius: 10px 0 0 10px;"
                        />
                        <button
                            wire:click="updateLabel({{ $loop->index }})"
                            type="button"
                            class="save-button btn btn-secondary"
                            style="max-width: fit-content; margin-top: 1.45rem; padding: 0.6rem 1rem;"
                        >
        ...
        {{-- Botão para gerar faixas automaticamente + campo com número de faixas --}}
        <div class="d-flex gap-2">
            <div class="btn-group">
                ...
                <x-input
                    ...
                    min="2"
                    max="10"
                    style="min-width: 75px; margin-top: 0.75rem; border-radius: 0 10px 10px 0;"
                />
            </div>
        </div>
    </div>
...
{{-- Script que exibe notificações tipo "toast" quando algo acontece no componente --}}
@script
    <script>
