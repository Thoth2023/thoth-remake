                            ...
                            <td>
                                @if ($database->files->isNotEmpty())
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                        @foreach ($database->files as $file)
                                            <tr>
                                                <td>{{ $file->file_name }}</td>
                                                <td class="text-center">
                                                    <button class="btn py-1 px-3 btn-outline-danger" wire:click="deleteFile('{{ $file->id }}')" wire:loading.attr="disabled">
