    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6 text-center mx-auto">
                <h1 class="text-white mb-2 mt-5">{{ __('pages/about.about') }}</h1>
        ...
        <div class="mt-lg-n12 mt-md-n13 mt-n12 justify-content-center">
            ...
            <div class="card d-inline-flex p-3 mt-8">
                ...
                <div class="card-body pt-2">
                    ...
                    <a class="nav-link d-flex align-items-center me-2" href="https://github.com/Thoth2023/thoth2.0/blob/main/LICENSE">
                ...
                <div class="card-body pt-2">
                    ...
                    <p>{{ __('pages/about.cross_platform_description') }}</p>
                    ...
                    <p>{{ __('pages/about.search_string_description') }}</p>

                    <a href="javascript:" class="card-title h6 d-block text-darker">
                        {{ __('pages/about.management_selection') }}
                    </a>
                    <p>{{ __('pages/about.management_selection_description') }}</p>

                    <a href="javascript:" class="card-title h6 d-block text-darker">
                        {{ __('pages/about.management_quality') }}
                    </a>
                    <p>{{ __('pages/about.management_quality_description') }}</p>

                    <a href="javascript:" class="card-title h6 d-block text-darker">
                    {{ __('pages/about.data_generation') }}
                    </a>
                    <p>{{ __('pages/about.data_generation_description') }}</p>

                    <a href="javascript:" class="card-title h6 d-block text-darker">
                    {{ __('pages/about.graphs_tables_generation') }}
                    </a>
                    <p>{{ __('pages/about.graphs_tables_generation_description') }}</p>

                    <a href="javascript:" class="card-title h6 d-block text-darker">
                    {{ __('pages/about.report_generation') }}
                    </a>
                    <p>{{ __('pages/about.report_generation_description') }}</p>
                    ...
                    <ul>
                        <li>
                            ...
                            <p>{{ __('pages/about.multiple_member_management_description') }}</p>
                        </li>
                        <li>
                            <a href="javascript:" class="card-title h5 d-block text-darker">
                        ...
                        <li>
                            ...
                            <p>{{ __('pages/about.study_information_visualization_description') }}
                            </p>
                        </li>
                        <li>
                            <a href="javascript:" class="card-title h5 d-block text-darker">
                        ...
                        <li>
                            ...
                            <p>{{ __('pages/about.quality_assessment_of_studies_description') }}
                            </p>
                        </li>
                        <li>
                            <a href="javascript:" class="card-title h5 d-block text-darker">
                        ...
                        <li>
                            ...
                            <p>{{ __('pages/about.data_extraction_description') }}</p>
                        </li>
                        <li>
                            <a href="javascript:" class="card-title h5 d-block text-darker">
                            {{ __('pages/about.report') }}
                            </a>
                            <p>{{ __('pages/about.report_description') }}</p>
                        </li>
                        <li>
                            <a href="javascript:" class="card-title h5 d-block text-darker">
                            {{ __('pages/about.export_to_latex') }}
                            </a>
                            <p>{{ __('pages/about.export_to_latex_description') }}</p>
                        </li>
                        <li>
                            <a href="javascript:" class="card-title h5 d-block text-darker">
                            {{ __('pages/about.export_to_bibtex') }}
                            </a>
                            <p>{{ __('pages/about.export_to_bibtex_description') }}</p>
                        </li>
                        <li>
                            <a href="javascript:" class="card-title h5 d-block text-darker">
                            {{ __('pages/about.improvement_of_search_strings') }}
                            </a>
                            <p>{{ __('pages/about.improvement_of_search_strings_description') }}</p>
                        </li>
                    </ul>
                </div>
