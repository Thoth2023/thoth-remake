...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => __("pages/news-sources.edit_source")])

    <div class="container mt-4 mb-3">
        <div class="card p-4 shadow-sm border-0">
            <h5 class="mb-4 fw-bold">
                <i class="fas fa-edit text-dark me-2"></i> {{ __("pages/news-sources.edit_source") }}
            </h5>

            <form method="POST" action="{{ route('news-sources.update', $newsSource->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="mb-3">
                    ...
                    <input type="text"
                           ...
                           required
                           value="{{ old('name', $newsSource->name) }}">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="url"
                           ...
                           value="{{ old('more_link', $newsSource->more_link) }}">
                    <small class="text-muted d-block mt-1">
                ...
                <div class="form-check form-switch mb-4">
                    <input class="form-check-input"
                           ...
                           name="active"
                           value="1"
                        {{ old('active', $newsSource->active) ? 'checked' : '' }}>
                    <label class="form-check-label fw-semibold" for="active">
                        {{ __('pages/news-sources.active') }}
                    </label>
                    <small class="text-muted d-block mt-1">
                ...
                <div class="d-flex justify-content-between mt-4">
                    ...
                    <button type="submit" class="btn btn-dark">
                        <i class="fas fa-save me-1"></i> {{ __("pages/news-sources.update") }}
                    </button>
                </div>
            </form>
        </div>
