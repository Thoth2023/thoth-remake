<body>
                ...
                <table class="table table-responsive-sm" id="table_papers_extraction">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="dropdown">
                                    <button class="btn btn-primary dropdown-toggle" type="button" id="dropdown_status_1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        Status
                                    </button>
                                    <div class="dropdown-menu" aria-labelledby="dropdown_status_1">
                                        ...
                                        <a class="dropdown-item" href="#" onclick="changeStatus(1, 'Removed')">Removed</a>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <button type="button" class="btn btn-primary btn-sm btn-view-paper" data-toggle="modal" data-target="#modal_paper_ex" data-paper-id="1">
                                    View Details
                                </button>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-primary btn-sm btn-view-paper" data-toggle="modal" data-target="#modal_paper_ex" data-paper-id="2">
                                    View Details
                                </button>
                            </td>
                        </tr>
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdown_status_1">
            ...
            <a class="dropdown-item" href="#" onclick="changeStatus(1, 'Removed')">Removed</a>
                            ...
                            <td>
                                <button type="button" class="btn btn-primary btn-sm btn-view-paper" data-toggle="modal" data-target="#modal_paper_ex" data-paper-id="3">
                                    View Details
                                </button>
                            </td>
                        </tr>
    ...
    <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.5.2/dist/umd/popper.min.js" integrity="sha384-D8R+zAoK5OKtOJR6VBMvaYuRZze+i/cacSA6kW0g1hCqcvKjpHrs26mN9RsVjFb" crossorigin="anonymous"></script>
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js" integrity="sha384-B4gt1jrGC7Jh4AgTPSdUtOBvfO8sh+JS83K9ZL8J3er2rBXVl4+76S1qqN0eg4J1" crossorigin="anonymous"></script>
