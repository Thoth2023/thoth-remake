    ...
    <div class="tab-pane fade show active" id="overall-info">
        <div class="row" style="justify-content: space-around;">
            ...
            <div class="col-md-6 unique-form-planning">
                <div class="card">
                    <form role="form" method="POST" action="{{ route('project.planning_overall.domainUpdate') }}"
                                ...
                                @forelse ($domains as $domain)
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            ...
                                            <!-- Modal Here Edition -->
                                            <div class="col-md-4">
                                                <div class="modal fade" id="modal-form{{ $domain->id_domain }}"
                            ...
                            <div class="form-group">
                                <select class="form-control" name="id_language">
                                    @forelse ($languages as $language)
                                        <option value="{{ $language->id_language }}">{{ $language->description }}
                                        </option>
                                    @empty
            ...
            <div>
                <div class="card-header pb-0">
                    <div class="d-flex align-items-center">
                        ...
                        <!-- Help Button Description -->
                        <div class="modal fade" id="StudyTypeModal" tabindex="-1" role="dialog"
                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                    ...
                    @forelse ($keywords as $keyword)
                        <tr>
                            ...
                            <td class="align-middle">
                                ...
                                <!-- Modal Here Edition -->
                                <div class="col-md-4">
                                    <div class="modal fade" id="modal-form{{ $keyword->id_keyword }}" tabindex="-1"
                    ...
                    <div>
                        <div class="card-header pb-0">
                            <div class="d-flex align-items-center">
                                ...
                                <!-- Help Button Description -->
                                <div class="modal fade" id="Criteria" tabindex="-1" role="dialog"
                                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="nav-wrapper position-relative end-0">
                            <ul class="nav nav-pills nav-fill p-1" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link mb-0 px-0 py-1"
                                        href="{{ route('project.planning.research_questions', $project->id_project) }}"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link mb-0 px-0 py-1 active"
                                        href="{{ route('project.planning.databases', $project->id_project) }}"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link mb-0 px-0 py-1" data-bs-toggle="tab"
                                        href="{{ route('project.search-strategy.edit', ['projectId' => $project->id_project]) }}"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link mb-0 px-0 py-1" href="#DataExtraction" role="tab"
                                        href="{{ route('project.planning.dataExtraction', $project->id_project) }}"
                                                            ...
                                                            <div class="modal fade" id="questionModal" tabindex="-1"
                                                                ...
                                                                <div class="modal-dialog modal-dialog-centered"
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title"
                                                                                id="exampleModalLabel">Edit Question
                                                                            </h5>
                                                                        </div>
                                                                        <div class="modal-body">
                                                                            <label class="form-control-label"
                                                                            ...
                                                                            <input class="form-control"
                                                                                ...
                                                                                name="description">
                                                                            <label class="form-control-lavel"
                                                                                for="type">Type</label>
