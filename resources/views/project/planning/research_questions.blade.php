                            ...
                            <div class="card-header pb-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <button type="button" class="help-thoth-button" data-bs-toggle="modal"
                                        data-bs-target="#ResearchQuestionsModal">
                                        ?
                                    </button>
                                    <!-- Help Button Description -->
                                    <div class="modal fade" id="ResearchQuestionsModal" tabindex="-1" role="dialog"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Help for Research
                                                        Questions</h5>
                                                                ...
                                                                <div class="card card-plain">
                                                                    ...
                                                                    <div class="card-body">
                                                                        <form role="form text-left" method="POST"
                                                                            action="{{ route('project.planning_research.Edit', $researchQuestion->id_research_question) }}">
                                                                            @csrf
                                                                            @method('PUT')
                                                                            <label>ID</label>
