                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Help for
                                                        Criteria</h5>
                                ...
                                @forelse ($project->inclusion_criterias as $criteria)
                                    <tr>
                                        <td>
                                            ...
                                            @else
                                                <form
                                                    ...
                                                    @csrf
                                                    @method('PUT')
                                                    <input type="checkbox" id="check-box-<?= $criteria->id_criteria ?>"
                                        ...
                                        <td class="align-middle">
                                            ...
                                            <!-- Modal Here Edition -->
                                            <div class="col-md-4">
                                                <div class="modal fade" id="modal-form{{ $criteria->id_criteria }}"
                                        ...
                                        <td class="align-middle">
                                            <form
                                                ...
                                                <button style="border:0; background: none; padding: 0px;"
                                                    type="submit" class="text-secondary font-weight-bold text-xs"
                                                    data-toggle="tooltip"
                                ...
                                <tbody>
                                    @forelse ($project->exclusion_criterias as $criteria)
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-sm font-weight-bold mb-0">{{ $criteria->description }}
                                                </p>
                                            </td>
                                            <td class="align-middle">
                                                <button style="border:0; background: none; padding: 0px;"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="modal fade"
                                                        id="modal-form{{ $criteria->id_criteria }}" tabindex="-1"
                                                        role="dialog" aria-labelledby="modal-form"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered modal-md"
                                                            role="document">
                                                            <div class="modal-content">
