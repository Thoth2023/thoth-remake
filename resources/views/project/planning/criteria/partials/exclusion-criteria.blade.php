        ...
        <div class="card-body">
            <div class="table-responsive p-0" id="exclusion_criteria">
                    ...
                    <thead>
                        <tr>
                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                {{ __('project/planning.criteria.exclusion-table.select') }}</th>
                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                    ...
                                    @if ($criterion->pre_selected == 0)
                                        <form
                                            ...
                                            <input type="checkbox" name="pre_selected" value="1"
                                                id="check-box-<?= $criterion->id_criteria ?>"
                ...
                <div class="col-md-2">
                    <br>
                    <label
                        class="form-control-label">{{ __('project/planning.criteria.exclusion-table.rule') }}</label>
                    <select class="form-control" name="exclusion_rule">
                        ...
                        <option value="at_least">{{ __('project/planning.criteria.exclusion-table.at-least') }}
                        </option>
                    </select>
                    <br>
                </div>
