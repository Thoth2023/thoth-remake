        ...
        <div class="card-body">
            <div class="table-responsive p-0" id="inclusion_criteria">
                    ...
                    <thead>
                        <tr>
                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                {{ __('project/planning.criteria.inclusion-table.select') }}</th>
                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                ...
                <div class="col-md-2">
                    <br>
                    <label
                        class="form-control-label">{{ __('project/planning.criteria.inclusion-table.rule') }}</label>
                    <select class="form-control" name="inclusion_rule">
                        ...
                        <option value="at_least">{{ __('project/planning.criteria.inclusion-table.at-least') }}
                        </option>
                    </select>
                    <br>
                </div>
