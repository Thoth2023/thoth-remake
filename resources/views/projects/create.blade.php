            ...
            <form method="POST" action="{{ route("projects.store") }}">
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        id="titleInput"
                        placeholder="{{ __("project/create.enter_title") }}"
                        value="{{ old("title") }}"
                    />
                    @error("title")
                ...
                <div class="form-group">
                    ...
                    <textarea
                        ...
                        rows="3"
                        placeholder="{{ __("project/create.enter_description") }}"
                    >
{{ old("description") }}</textarea
                ...
                <div class="form-group">
                    <label for="objectivesTextarea">
                        {{ __("project/create.objectives") }}
                    </label>
                    <textarea
                        name="objectives"
                        class="form-control @error("objectives")  is-invalid @enderror"
                        id="objectivesTextarea"
                        rows="3"
                        placeholder="{{ __("project/create.enter_objectives") }}"
                    >
{{ old("objectives") }}</textarea
                ...
                <div class="form-group">
                    <label for="copy_planning">
                        {{ __("project/create.copy_planning") }}
                    </label>
                    <select
                        class="form-control"
                        id="copy_planning"
                ...
                <div class="form-check">
                    <input
                        ...
                        {{ old("feature_review") == "Systematic review" ? "checked" : "" }}
                    />
                    <label class="form-check-label" for="feature_review1">
                        {{ __("project/create.systematic_review") }}
                    </label>
                </div>
                <div class="form-check">
                    <input
                        ...
                        {{ old("feature_review") == "Systematic review and Snowballing" ? "checked" : "" }}
                    />
                ...
                <div class="form-check">
                    <input
                        ...
                        id="feature_review3"
                        value="Snowballing"
                        {{ old("feature_review") == "Snowballing" ? "checked" : "" }}
                    />
