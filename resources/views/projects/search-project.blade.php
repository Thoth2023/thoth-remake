                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            <div class="table-responsive p-0">
                                ...
                                <table class="table align-items-center justify-content-start mb-0 thoth-project-table">
                                    <thead>
                                    <tr>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                            {{ __('project/search.project.table.headers.title') }}
                                        </th>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">
                                            {{ __('project/search.project.table.headers.created_by') }}
                                        </th>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder text-center opacity-7 ps-2">
                                            {{ __('project/search.project.table.headers.completion') }}
                                        </th>
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder text-center opacity-7 ps-2">
                                            {{ __('project/search.project.table.headers.options') }}
                                        </th>
                                        <th></th>
                                    </tr>
                                    </thead>
                                    ...
                                    @forelse ($projects as $project)
                                        <tr class="project-row-card">
                                            ...
                                            {{-- TÍTULO + DESCRIÇÃO --}}
                                            <td data-title="{{ __('project/search.project.table.headers.title') }}">
                                                <div class="px-3">
                                            ...
                                            {{-- CRIADO POR --}}
                                            <td data-title="{{ __('project/search.project.table.headers.created_by') }}">
                                                <p class="text-sm font-weight-bold mb-0">{{ $project->created_by }}</p>
                                            </td>

                                            {{-- PROGRESSO --}}
                                            <td class="align-middle text-center"
                                                data-title="{{ __('project/search.project.table.headers.completion') }}">
                                            ...
                                            <td class="d-flex mt-3 align-items-center justify-content-end gap-1"
                                                data-title="{{ __('project/search.project.table.headers.options') }}">
