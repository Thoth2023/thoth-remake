...
class FileUpload extends Component
{
    ...
    private function mapCsvFields($csvRow)
    {
        return [
            ...
            'citation-key' => $csvRow['Citation Key'] ?? '',
            ...
            'abstract' => !empty($csvRow['Abstract']) ? $csvRow['Abstract'] : null,
            'keywords' => !empty($csvRow['Keywords']) ? $csvRow['Keywords'] : null,
            ...
            'url' => !empty($csvRow['Item URL']) ? $csvRow['Item URL'] : null,
            'publisher' => $csvRow['Publisher'] ?? '',
            'year' => !empty($csvRow['Publication Year']) ? $csvRow['Publication Year'] : null,
        ];
    }
