...
URL = "http://localhost:8989/projects/1/edit"
...
def teste_todos_os_campos_vazios_edicao():
...
def teste_campo_vazio_edicao(campo_id, campo_nome):
    driver = iniciar_driver()
...
if __name__ == "__main__":
    teste_todos_os_campos_vazios_edicao()
    teste_campo_vazio_edicao("titleInput", "Título")
    teste_campo_vazio_edicao("descriptionTextarea", "Descrição")
    teste_campo_vazio_edicao("objectivesTextarea", "Objetivos")
